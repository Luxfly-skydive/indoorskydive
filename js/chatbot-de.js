(function () {
  ...
  document.body.insertAdjacentHTML('beforeend', `
    ...
    <div id="lf-chat-window" role="dialog" aria-label="Luxfly Chat">
      ...
      <div id="lf-chat-quick">
        <button class="lf-quick-btn" data-q="Was kosten die Pakete?">💰 Preise</button>
        <button class="lf-quick-btn" data-q="Wann haben Sie geöffnet?">🕐 Öffnungszeiten</button>
      ...
      <form id="lf-chat-form" autocomplete="off">
        <textarea id="lf-chat-input" placeholder="Fragen Sie mich etwas…" rows="1"></textarea>
  ...
  async function sendMessage(text) {
    ...
    try {
      ...
      removeTyping();
      addMsg('Verbindungsproblem. Schreiben Sie an **hello@luxfly.eu** oder WhatsApp **+32 2 320 55 09** 😊', 'bot');
    }
    input.focus();
  }
  ...
  function openChat() {
    ...
    if (!greeted) {
      greeted = true;
      setTimeout(() => { addMsg('Hallo! 👋 Ich bin Zoom, der LUXFLY-Geburtstagschatbot. Fragen Sie mich zu unseren Paketen für Kinder und Teens — Preise, HighFly, Buchung, Standort und mehr!', 'bot'); }, 300);
    }
  ...
  bubble.id = 'lf-chat-bubble'; bubble.textContent = 'Eine Frage? Hier stellen!';
