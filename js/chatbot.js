(function () {
  ...
  async function sendMessage(text) {
    ...
    try {
      ...
      removeTyping();
      addMsg('Connection issue. Email **hello@luxfly.eu** or WhatsApp **+32 2 320 55 09** 😊', 'bot');
    }
    input.focus();
  }
  ...
  function openChat() {
    ...
    if (!greeted) {
      greeted = true;
      setTimeout(() => { addMsg('Hey! 👋 I\'m Zoom, the LUXFLY Birthday assistant. Ask me about our kids & teen party packages — prices, HighFly, booking, location, and more!', 'bot'); }, 300);
    }
  ...
  bubble.id = 'lf-chat-bubble'; bubble.textContent = 'Have a question? Ask here!';
